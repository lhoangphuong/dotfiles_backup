...
o.shiftwidth = 4                -- number (default 8): number of spaces to use for (auto)indent step
o.tabstop = 4                   -- number (default 8): number of spaces that <Tab> in file uses
o.softtabstop = 4               -- number (default 0): number of spaces that <Tab> uses while editing
